...
export declare const useEnterprise: <TCEData, TEEData = TCEData, TCombinedValue = TEEData, TDefaultValue = TCEData | null>(ceData: TCEData, eeCallback: () => Promise<TEEData>, opts?: UseEnterpriseOptions<TCEData, TEEData, TDefaultValue, TCombinedValue>) => UseEnterpriseReturn<TCEData, TEEData, TDefaultValue, TCombinedValue>;
export {};
