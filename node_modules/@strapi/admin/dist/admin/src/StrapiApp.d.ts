...
declare class StrapiApp {
    ...
    injectContentManagerComponent: <TContainerName extends "editView" | "listView">(containerName: TContainerName, blockName: keyof {
        editView: {
    ...
    runHookWaterfall: (name: string, initialValue: unknown, asynchronous?: boolean, store?: unknown) => unknown;
