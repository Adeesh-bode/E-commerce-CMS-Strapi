...
import { V as useTypedStore } from "./index-8933483b.mjs";
...
import { u as useDragAndDrop, c as composeRefs } from "./schema-6bd8bd85.mjs";
import "axios";
...
import { a as getAvailableStageColors, g as getStageColorByHex } from "./colors-e7489dd4.mjs";
                      ...
                      return /* @__PURE__ */ jsx(
                        MultiSelectGroup,
                        {
                          ...
                          children: role.children.map((role2) => {
                            return /* @__PURE__ */ jsx(NestedOption$1, { value: role2.value, children: role2.label }, role2.value);
                          })
                        },
                        role.label
                      );
                    }
                    return /* @__PURE__ */ jsx(MultiSelectOption, { value: role.value, children: role.label }, role.value);
                  })
                }
              ) }),
              /* @__PURE__ */ jsx(
...
function Stages({ canDelete, canUpdate, stages }) {
  ...
  return /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 6, width: "100%", children: [
    /* @__PURE__ */ jsxs(Box, { position: "relative", spacing: 4, width: "100%", children: [
      /* @__PURE__ */ jsx(
        Background,
        {
            ...
            return /* @__PURE__ */ jsx(
              MultiSelectGroup,
              {
                ...
                children: opt.children.map((child) => {
                  ...
                  return /* @__PURE__ */ jsx(NestedOption, { value: child.value, children: formatMessage(
                    {
...
//# sourceMappingURL=validateWorkflow-7a2b6ab8.mjs.map
