          ...
          designSystem.Box,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(
              GuidedTourStepper,
              {
                ...
                stepIndex,
                hasSectionAfter,
                children: /* @__PURE__ */ jsxRuntime.jsx(GuidedTourContent, { ...stepData.content })
              }
            )
          }
        ),
...
const GuidedTourStepper = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "alpha", fontWeight: "bold", textColor: "neutral800", as: "h3", id: "title", children: formatMessage(title) })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { alignItems: "stretch", children: [
...
const CM = React__namespace.lazy(
  ...
  () => Promise.resolve().then(() => require("./index-82c7a120.js")).then((n) => n.index)
);
const HomePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./HomePage-6ff9e578.js")).then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./InstalledPluginsPage-3ae5dbb6.js")).then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./MarketplacePage-e7cd973b.js")).then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-4de70b5d.js")).then((n) => n.NotFoundPage).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./ProfilePage-52844daa.js")).then((mod) => ({
...
const SettingsPage = React__namespace.lazy(
  () => (
    // @ts-expect-error – No types, yet.
    Promise.resolve().then(() => require("./index-c97f5820.js")).then((module2) => ({
      default: module2.SettingsPage
    }))
  )
);
const Admin = () => {
...
const AuthenticatedApp = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    helperPlugin.AppInfoProvider,
    {
      ...
      shouldUpdateStrapi,
      userDisplayName,
      children: /* @__PURE__ */ jsxRuntime.jsxs(index.RBACProvider, { permissions: permissions ?? [], refetchPermissions: refetch, children: [
...
//# sourceMappingURL=AuthenticatedApp-342bf22f.js.map
