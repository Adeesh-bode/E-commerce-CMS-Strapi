...
import { A as ApiTokenCreateView } from "./index-ad8e55c0.mjs";
import "react";
import "react-query";
...
const ProtectedApiTokenCreateView = () => {
  ...
  return /* @__PURE__ */ jsx(CheckPagePermissions, { permissions: permissions.settings["api-tokens"].create, children: /* @__PURE__ */ jsx(ApiTokenCreateView, {}) });
};
export {
  ProtectedApiTokenCreateView as default
};
//# sourceMappingURL=index-383efae4.mjs.map
