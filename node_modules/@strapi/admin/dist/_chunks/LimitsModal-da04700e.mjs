...
import { Typography, ModalLayout, ModalBody, Flex, Box, IconButton } from "@strapi/design-system";
...
function Title({ children }) {
  return /* @__PURE__ */ jsx(Typography, { variant: "alpha", id: TITLE_ID, children });
}
Title.propTypes = {
...
function LimitsModal({ children, isOpen, onClose }) {
  ...
  return /* @__PURE__ */ jsx(ModalLayout, { labelledBy: TITLE_ID, children: /* @__PURE__ */ jsx(ModalBody, { children: /* @__PURE__ */ jsxs(Flex, { gap: 2, paddingLeft: 7, position: "relative", children: [
...
//# sourceMappingURL=LimitsModal-da04700e.mjs.map
