...
import { E as EditView } from "./index-91df57b1.mjs";
import "react";
import "react-query";
...
const ProtectedCreateView = () => {
  ...
  return /* @__PURE__ */ jsx(CheckPagePermissions, { permissions: permissions.settings.webhooks.create, children: /* @__PURE__ */ jsx(EditView, {}) });
};
export {
  ProtectedCreateView as default
};
//# sourceMappingURL=index-ac85118a.mjs.map
