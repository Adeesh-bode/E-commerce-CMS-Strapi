...
import { useAppInfo, useTracking, useNotification, useOverlayBlocker, useFetchClient, useFocusWhenNavigate, auth, LoadingIndicatorPage, Form, pxToRem, GenericInput } from "@strapi/helper-plugin";
...
const schema = yup.object().shape(schema$1);
const ProfilePage = () => {
