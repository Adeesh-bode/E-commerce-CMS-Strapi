...
import { u as useConfiguration, c as createTypedSelector, a as useTypedDispatch, b as useTypedSelector, A as ACTION_SET_APP_RUNTIME_STATUS, d as createRoute, R as RBACProvider, N as NpsSurvey } from "./index-8933483b.mjs";
          ...
          Box,
          {
            ...
            children: /* @__PURE__ */ jsx(
              GuidedTourStepper,
              {
                ...
                stepIndex,
                hasSectionAfter,
                children: /* @__PURE__ */ jsx(GuidedTourContent, { ...stepData.content })
              }
            )
          }
        ),
...
const GuidedTourStepper = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Flex, { children: [
      ...
      /* @__PURE__ */ jsx(Typography, { variant: "alpha", fontWeight: "bold", textColor: "neutral800", as: "h3", id: "title", children: formatMessage(title) })
    ] }),
    /* @__PURE__ */ jsxs(Flex, { alignItems: "stretch", children: [
...
const CM = React.lazy(
  ...
  () => import("./index-bd18f803.mjs").then((n) => n.i)
);
const HomePage = React.lazy(
  () => import("./HomePage-246cc590.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-170aff77.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-1cbfa8fd.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-8933483b.mjs").then((n) => n.Y).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-ef400907.mjs").then((mod) => ({
...
const SettingsPage = React.lazy(
  () => (
    // @ts-expect-error – No types, yet.
    import("./index-26fcb3ca.mjs").then((module) => ({
...
const AuthenticatedApp = () => {
  ...
  return /* @__PURE__ */ jsx(
    AppInfoProvider,
    {
      ...
      shouldUpdateStrapi,
      userDisplayName,
      children: /* @__PURE__ */ jsxs(RBACProvider, { permissions: permissions ?? [], refetchPermissions: refetch, children: [
...
//# sourceMappingURL=AuthenticatedApp-bb31f306.mjs.map
