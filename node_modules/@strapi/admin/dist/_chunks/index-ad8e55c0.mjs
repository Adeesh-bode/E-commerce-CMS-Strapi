...
import { useState, useEffect, memo, useRef, useReducer } from "react";
...
import { useFocusWhenNavigate, SettingsPageTitle, LoadingIndicatorPage, useOverlayBlocker, useNotification, useTracking, useGuidedTour, useRBAC, useFetchClient, Form } from "@strapi/helper-plugin";
...
import { T as TokenName, a as TokenDescription, L as LifeSpanInput, b as TokenTypeSelect, s as schema, F as FormHead, c as TokenBox } from "./index-176cc121.mjs";
...
const ActionBoundRoutes = () => {
  ...
  return /* @__PURE__ */ jsx(
    GridItem,
    {
      ...
      paddingRight: 7,
      style: { minHeight: "100%" },
      children: selectedAction ? /* @__PURE__ */ jsx(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: routes[actionSection]?.map((route) => {
...
const ApiTokenCreateView = () => {
  ...
  const [state, dispatch] = useReducer(reducer, initialState, (state2) => init(state2, {}));
  const {
    params: { id }
...
export {
  ApiTokenCreateView as A
};
//# sourceMappingURL=index-ad8e55c0.mjs.map
