...
const findAttributeIndex = (schema, attributeToFind) => {
  return schema.schema.attributes.findIndex(({ name: name2 }) => name2 === attributeToFind);
};
      ...
      case EDIT_ATTRIBUTE: {
        ...
        if (oppositeAttributeNameToRemove) {
          const indexToRemove = updatedAttributes.findIndex(
            ({ name: name22 }) => name22 === oppositeAttributeNameToRemove
          );
...
const index = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-0f00418d.js")).then((n) => n.index);
        return component;
      }
    });
    app.registerPlugin({
...
//# sourceMappingURL=index-e2b1b2e6.js.map
