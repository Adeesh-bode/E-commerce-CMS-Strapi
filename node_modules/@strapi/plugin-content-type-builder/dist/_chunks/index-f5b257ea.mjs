...
import React, { createContext, useContext, useState, useRef, useEffect, useMemo, useCallback, memo, lazy, Suspense } from "react";
import { Box, TextButton, Icon, MultiSelectNested, Flex, Typography, KeyboardNavigable, Grid, GridItem, LinkButton, Link, ModalBody, TabGroup, Tabs, Tab, Divider, TabPanels, TabPanel, Select, Option, inputFocusStyle, Checkbox, TextInput, NumberInput, Button, ModalHeader, Searchbar, IconButton, Tooltip, Field, FieldLabel, VisuallyHidden, FieldInput, CreatableCombobox, ComboboxOption, Textarea, ModalLayout, ModalFooter, Layout } from "@strapi/design-system";
import { useNotification, useTracking, useFilter, useCollator, pxToRem, useCustomFields, ConfirmDialog, Link as Link$1, GenericInput, translatedErrors, useStrapiApp, getYupInnerErrors, useAutoReloadOverlayBlocker, useGuidedTour, useAppInfo, useRBACProvider, useFetchClient, LoadingIndicatorPage, CheckPagePermissions } from "@strapi/helper-plugin";
import { Helmet } from "react-helmet";
import { useIntl } from "react-intl";
import { NavLink, useHistory, useLocation, useRouteMatch, Redirect, useParams, Switch, Route } from "react-router-dom";
import { SubNav, SubNavHeader, SubNavSections, SubNavSection, SubNavLinkSection, SubNavLink, Breadcrumbs, Crumb, Menu } from "@strapi/design-system/v2";
  ...
  return /* @__PURE__ */ jsxs(
    SubNav,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(SubNavSections, { children: menu.map((section) => /* @__PURE__ */ jsxs(React.Fragment, { children: [
          /* @__PURE__ */ jsx(
            SubNavSection,
            {
              label: formatMessage({
              ...
              children: section.links.map((link) => {
                ...
                return /* @__PURE__ */ jsx(SubNavLink, { as: NavLink, to: link.to, active: link.active, children: upperFirst(formatMessage({ id: link.name, defaultMessage: link.title })) }, link.name);
              })
            }
          ),
...
const NewBadge = () => /* @__PURE__ */ jsx(Flex, { grow: 1, justifyContent: "flex-end", children: /* @__PURE__ */ jsxs(
  Flex,
  {
    gap: 1,
    fontSizes: 0,
...
const AttributeOption = ({ type }) => {
  ...
  return /* @__PURE__ */ jsx(BoxWrapper, { padding: 4, as: "button", hasRadius: true, type: "button", onClick: handleClick, children: /* @__PURE__ */ jsxs(Flex, { children: [
...
const BooleanRadioGroup = ({ onChange, name, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(CustomRadioGroup, { ...rest, name, onChange: handleChange });
};
...
const FormModalEndActions = ({
  ...
  if (isContentTypeModal) {
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      !isCreatingContentType && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(
          Button,
          {
            type: "button",
  ...
  if (isComponentModal) {
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      !isCreatingComponent && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(
          Button,
          {
            type: "button",
...
const IconPick = ({ iconKey, name, onChange, isSelected, ariaLabel }) => {
  return /* @__PURE__ */ jsx(Field, { name, required: false, children: /* @__PURE__ */ jsxs(FieldLabel, { htmlFor: iconKey, id: `${iconKey}-label`, children: [
    ...
    /* @__PURE__ */ jsx(Flex, { padding: 2, cursor: "pointer", hasRadius: true, background: isSelected && "primary200", children: /* @__PURE__ */ jsx(Icon, { as: COMPONENT_ICONS[iconKey], color: isSelected ? "primary600" : "neutral300" }) })
  ] }) });
};
IconPick.propTypes = {
...
const RelationTargetPicker = ({ oneThatIsCreatingARelationWithAnother, target }) => {
  ...
  return /* @__PURE__ */ jsxs(Menu.Root, { children: [
    ...
    /* @__PURE__ */ jsx(Menu.Content, { zIndex: 5, children: allowedContentTypesForRelation.map(({ uid, title, restrictRelationsTo, plugin: plugin2 }) => /* @__PURE__ */ jsxs(Menu.Item, { onSelect: handleSelect({ uid, plugin: plugin2, title, restrictRelationsTo }), children: [
      title,
      " ",
      plugin2 && /* @__PURE__ */ jsxs(Fragment, { children: [
        "(from: ",
        plugin2,
        ")"
      ] })
...
const sortContentType = (types2) => sortBy(
...
const DataManagerProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx(
    DataManagerContext.Provider,
    {
      ...
      children: isLoadingForDataToBeSet ? /* @__PURE__ */ jsx(LoadingIndicatorPage, {}) : /* @__PURE__ */ jsxs(Fragment, { children: [
        children,
...
const ListView$1 = lazy(() => import("./index-99f0f1cd.mjs"));
const RecursivePath = () => {
  const { url } = useRouteMatch();
  const { categoryUid } = useParams();
  return /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(LoadingIndicatorPage, {}), children: /* @__PURE__ */ jsx(Switch, { children: /* @__PURE__ */ jsx(Route, { path: `${url}/:componentUid`, children: /* @__PURE__ */ jsx(ListView$1, { categoryId: categoryUid }) }) }) });
};
const ListView = lazy(() => import("./index-99f0f1cd.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-f5b257ea.mjs.map
