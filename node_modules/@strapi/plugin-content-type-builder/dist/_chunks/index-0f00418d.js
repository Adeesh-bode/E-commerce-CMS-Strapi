...
const index$1 = require("./index-e2b1b2e6.js");
...
const useContentTypeBuilderMenu = () => {
  ...
  const canOpenModalCreateCTorComponent = !Object.keys(contentTypes).some((ct) => contentTypes[ct].isTemporary === true) && !Object.keys(components).some((component) => components[component].isTemporary === true) && isEqual__default.default(modifiedData, initialData);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    v2.SubNav,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(v2.SubNavSections, { children: menu.map((section) => /* @__PURE__ */ jsxRuntime.jsxs(React__default.default.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            v2.SubNavSection,
            {
              label: formatMessage({
              ...
              children: section.links.map((link) => {
                ...
                return /* @__PURE__ */ jsxRuntime.jsx(v2.SubNavLink, { as: reactRouterDom.NavLink, to: link.to, active: link.active, children: upperFirst__default.default(formatMessage({ id: link.name, defaultMessage: link.title })) }, link.name);
              })
            }
          ),
...
AllowedTypesSelect.propTypes = {
  ...
  value: PropTypes__default.default.oneOfType([PropTypes__default.default.object, PropTypes__default.default.array])
};
const iconByTypes = {
...
AttributeIcon.propTypes = {
  ...
  customField: PropTypes__default.default.string
};
...
const NewBadge = () => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { grow: 1, justifyContent: "flex-end", children: /* @__PURE__ */ jsxRuntime.jsxs(
  designSystem.Flex,
  {
    gap: 1,
    fontSizes: 0,
...
const AttributeOption = ({ type }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(BoxWrapper, { padding: 4, as: "button", hasRadius: true, type: "button", onClick: handleClick, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { children: [
...
AttributeList.propTypes = {
  attributes: PropTypes__default.default.array.isRequired
};
...
CustomFieldOption.propTypes = {
  customFieldUid: PropTypes__default.default.string.isRequired,
  customField: PropTypes__default.default.shape({
    type: PropTypes__default.default.string.isRequired,
    ...
    intlDescription: PropTypes__default.default.shape({
      id: PropTypes__default.default.string.isRequired,
      defaultMessage: PropTypes__default.default.string.isRequired
    }).isRequired
  }).isRequired
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { position: "relative", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { position: "absolute", top: 6, width: "100%", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { alignItems: "center", justifyContent: "center", direction: "column", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          to: `/marketplace?${qs__default.default.stringify({ categories: ["Custom fields"] })}`,
          variant: "secondary",
...
AttributeOptions.propTypes = {
  attributes: PropTypes__default.default.array.isRequired,
  forTarget: PropTypes__default.default.string.isRequired,
  kind: PropTypes__default.default.string.isRequired
};
const BooleanDefaultValueSelect = ({ intlLabel, name, options: options2, onChange, value }) => {
  const { formatMessage } = reactIntl.useIntl();
...
BooleanDefaultValueSelect.propTypes = {
  ...
  options: PropTypes__default.default.arrayOf(
    PropTypes__default.default.shape({
      ...
      key: PropTypes__default.default.oneOfType([PropTypes__default.default.string, PropTypes__default.default.number]).isRequired,
...
CustomRadioGroup.propTypes = {
  ...
  name: PropTypes__default.default.string.isRequired,
  onChange: PropTypes__default.default.func.isRequired,
  radios: PropTypes__default.default.arrayOf(
    PropTypes__default.default.shape({
...
const BooleanRadioGroup = ({ onChange, name, ...rest }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(CustomRadioGroup, { ...rest, name, onChange: handleChange });
};
...
CheckboxWithNumberField.propTypes = {
  ...
  modifiedData: PropTypes__default.default.object.isRequired,
  name: PropTypes__default.default.string.isRequired,
  onChange: PropTypes__default.default.func.isRequired,
...
FormModalEndActions.propTypes = {
  categoryName: PropTypes__default.default.string,
  deleteCategory: PropTypes__default.default.func.isRequired,
  deleteComponent: PropTypes__default.default.func.isRequired,
  deleteContentType: PropTypes__default.default.func.isRequired,
  isAttributeModal: PropTypes__default.default.bool.isRequired,
  isCustomFieldModal: PropTypes__default.default.bool.isRequired,
  isComponentAttribute: PropTypes__default.default.bool.isRequired,
  isComponentModal: PropTypes__default.default.bool.isRequired,
  isComponentToDzModal: PropTypes__default.default.bool.isRequired,
  isContentTypeModal: PropTypes__default.default.bool.isRequired,
  isCreatingComponent: PropTypes__default.default.bool.isRequired,
  isCreatingComponentAttribute: PropTypes__default.default.bool.isRequired,
  isCreatingComponentInDz: PropTypes__default.default.bool.isRequired,
  isCreatingComponentWhileAddingAField: PropTypes__default.default.bool.isRequired,
  isCreatingContentType: PropTypes__default.default.bool.isRequired,
  isCreatingDz: PropTypes__default.default.bool.isRequired,
  isDzAttribute: PropTypes__default.default.bool.isRequired,
  isEditingAttribute: PropTypes__default.default.bool.isRequired,
  isEditingCategory: PropTypes__default.default.bool.isRequired,
  isInFirstComponentStep: PropTypes__default.default.bool.isRequired,
  onSubmitAddComponentAttribute: PropTypes__default.default.func.isRequired,
  onSubmitAddComponentToDz: PropTypes__default.default.func.isRequired,
  onSubmitCreateContentType: PropTypes__default.default.func.isRequired,
  onSubmitCreateComponent: PropTypes__default.default.func.isRequired,
  onSubmitCreateDz: PropTypes__default.default.func.isRequired,
  onSubmitEditAttribute: PropTypes__default.default.func.isRequired,
  onSubmitEditCategory: PropTypes__default.default.func.isRequired,
  onSubmitEditComponent: PropTypes__default.default.func.isRequired,
  onSubmitEditContentType: PropTypes__default.default.func.isRequired,
  onSubmitEditCustomFieldAttribute: PropTypes__default.default.func.isRequired,
  onSubmitEditDz: PropTypes__default.default.func.isRequired,
  onClickFinish: PropTypes__default.default.func
};
const FormModalHeader = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalHeader, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 3, children: [
    showBackLink && /* @__PURE__ */ jsxRuntime.jsx(
      helperPlugin.Link,
      {
...
FormModalHeader.propTypes = {
  ...
  attributeName: PropTypes__default.default.string,
  attributeType: PropTypes__default.default.string,
  categoryName: PropTypes__default.default.string,
  contentTypeKind: PropTypes__default.default.string,
  dynamicZoneTarget: PropTypes__default.default.string,
  forTarget: PropTypes__default.default.oneOf(["contentType", "component", "components"]),
  modalType: PropTypes__default.default.string.isRequired,
  targetUid: PropTypes__default.default.string,
  customFieldUid: PropTypes__default.default.string,
  showBackLink: PropTypes__default.default.bool
};
...
const FormModalSubHeader = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "flex-start", paddingBottom: 2, gap: 1, children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { as: "h2", variant: "beta", children: formatMessage(
      ...
      {
        type: upperFirst__default.default(formatMessage(intlLabel)),
...
FormModalSubHeader.propTypes = {
  ...
  forTarget: PropTypes__default.default.string,
  kind: PropTypes__default.default.string,
  step: PropTypes__default.default.string,
  attributeType: PropTypes__default.default.string,
  attributeName: PropTypes__default.default.string,
  customField: PropTypes__default.default.object
};
...
const IconPick = ({ iconKey, name, onChange, isSelected, ariaLabel }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field, { name, required: false, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.FieldLabel, { htmlFor: iconKey, id: `${iconKey}-label`, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { padding: 2, cursor: "pointer", hasRadius: true, background: isSelected && "primary200", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Icon, { as: COMPONENT_ICONS[iconKey], color: isSelected ? "primary600" : "neutral300" }) })
  ] }) });
};
IconPick.propTypes = {
  iconKey: PropTypes__default.default.string.isRequired,
  name: PropTypes__default.default.string.isRequired,
  onChange: PropTypes__default.default.func.isRequired,
...
IconPicker.propTypes = {
  intlLabel: PropTypes__default.default.object.isRequired,
  name: PropTypes__default.default.string.isRequired,
  onChange: PropTypes__default.default.func.isRequired,
...
RelationTargetPicker.propTypes = {
  oneThatIsCreatingARelationWithAnother: PropTypes__default.default.string.isRequired,
...
RelationFormBox.propTypes = {
  ...
  isMain: PropTypes__default.default.bool,
  name: PropTypes__default.default.string.isRequired,
  onChange: PropTypes__default.default.func,
  oneThatIsCreatingARelationWithAnother: PropTypes__default.default.string,
  target: PropTypes__default.default.string,
  value: PropTypes__default.default.string
};
...
RelationNaturePicker.propTypes = {
  naturePickerType: PropTypes__default.default.string.isRequired,
  oneThatIsCreatingARelationWithAnother: PropTypes__default.default.string.isRequired,
...
Relation.propTypes = {
  formErrors: PropTypes__default.default.object.isRequired,
  mainBoxHeader: PropTypes__default.default.string.isRequired,
  modifiedData: PropTypes__default.default.object.isRequired,
  naturePickerType: PropTypes__default.default.string.isRequired,
  onChange: PropTypes__default.default.func.isRequired
};
...
SelectComponent.propTypes = {
  componentToCreate: PropTypes__default.default.object,
  forTarget: PropTypes__default.default.string.isRequired,
  error: PropTypes__default.default.string,
  intlLabel: PropTypes__default.default.shape({
    id: PropTypes__default.default.string.isRequired,
  ...
  isAddingAComponentToAnotherComponent: PropTypes__default.default.bool.isRequired,
  isCreating: PropTypes__default.default.bool.isRequired,
  isCreatingComponentWhileAddingAField: PropTypes__default.default.bool.isRequired,
  name: PropTypes__default.default.string.isRequired,
  onChange: PropTypes__default.default.func.isRequired,
  targetUid: PropTypes__default.default.string.isRequired,
...
SelectComponents.propTypes = {
  ...
  dynamicZoneTarget: PropTypes__default.default.string.isRequired,
  name: PropTypes__default.default.string.isRequired,
  onChange: PropTypes__default.default.func.isRequired,
  value: PropTypes__default.default.array.isRequired
};
const SelectDateType = ({ intlLabel, error, modifiedData, name, onChange, options: options2, value }) => {
  const { formatMessage } = reactIntl.useIntl();
  const label = formatMessage(intlLabel);
  const errorMessage = error ? formatMessage({ id: error, defaultMessage: error }) : "";
...
const SelectNumber = ({ intlLabel, error, modifiedData, name, onChange, options: options2, value }) => {
  const { formatMessage } = reactIntl.useIntl();
  const label = formatMessage(intlLabel);
  const errorMessage = error ? formatMessage({ id: error, defaultMessage: error }) : "";
  const handleChange = (nextValue) => {
...
const TabForm = ({ form: form2, formErrors, genericInputProps, modifiedData, onChange }) => {
  const { formatMessage } = reactIntl.useIntl();
  return form2.map((section, sectionIndex) => {
...
TabForm.propTypes = {
  form: PropTypes__default.default.arrayOf(PropTypes__default.default.object).isRequired,
  formErrors: PropTypes__default.default.object.isRequired,
  genericInputProps: PropTypes__default.default.object.isRequired,
  modifiedData: PropTypes__default.default.object.isRequired,
  onChange: PropTypes__default.default.func.isRequired
};
const TextareaEnum = ({
...
TextareaEnum.propTypes = {
  ...
  value: PropTypes__default.default.oneOfType([PropTypes__default.default.array, PropTypes__default.default.string])
};
const nameField$1 = {
  name: "name",
  type: "text",
        ...
        sections: [
          {
            ...
            items: [attributeOptions.required, attributeOptions.private, attributeOptions.max, attributeOptions.min]
          }
        ]
      };
    }
    ...
    return {
      sections: [
        ...
        },
        {
          ...
          items: [attributeOptions.required, attributeOptions.unique, attributeOptions.max, attributeOptions.min, attributeOptions.private]
        }
      ]
    };
  },
    ...
    return {
      sections: [
        { sectionTitle: null, items: [attributeOptions.default] },
        {
          ...
          items: [attributeOptions.required, attributeOptions.maxLength, attributeOptions.minLength, attributeOptions.private]
        }
      ]
    };
  },
  ...
  uid(data) {
    return {
      sections: [
        {
          sectionTitle: null,
          items: [{ ...attributeOptions.default, disabled: Boolean(data.targetField), type: "text" }]
        },
        {
          sectionTitle: {
            id: "global.settings",
  ...
  enumeration(usedAttributeNames, reservedNames) {
    ...
    const shape = {
      ...
      enum: yup__namespace.array().of(yup__namespace.string()).min(1, helperPlugin.translatedErrors.min).test({
        ...
        test: (values) => values.map(toRegressedEnumValue).every((value) => GRAPHQL_ENUM_REGEX.test(value))
      }),
  ...
  relation(usedAttributeNames, reservedNames, alreadyTakenTargetAttributes, { initialData, modifiedData }) {
    const shape = {
      ...
      targetAttribute: yup__namespace.lazy(() => {
        ...
        let schema = yup__namespace.string().test(isNameAllowed(reservedNames));
...
const forms = {
  customField: {
    schema({
      ...
      const attributeShape = types[attributeType](
        usedAttributeNames,
  ...
  attribute: {
    schema(currentSchema, attributeType, reservedNames, alreadyTakenTargetContentTypeAttributes, options2, extensions) {
      ...
      try {
        let attributeShape = types[attributeType](
          usedAttributeNames,
          reservedNames.attributes,
        ...
        return types.default(usedAttributeNames, reservedNames.attributes);
      }
    },
    form: {
      advanced({ data, type, step, extensions, ...rest }) {
        try {
          const baseForm2 = form$1.advanced[type](data, step).sections;
      ...
      base({ data, type, step, attributes }) {
        try {
          return form$1.base[type](data, step, attributes);
        } catch (err) {
    ...
    form: {
      base({ actionType }) {
        if (actionType === "create") {
          return forms$1.base.create();
        }
        return forms$1.base.edit();
      },
      advanced({ extensions }) {
        const baseForm2 = forms$1.advanced.default().sections.map((section) => section.items).flat();
  ...
  addComponentToDynamicZone: {
    form: {
      advanced() {
        return form.advanced.default();
      },
      base({ data }) {
        const isCreatingComponent = data?.createComponent ?? false;
        if (isCreatingComponent) {
          return form.base.createComponent();
        }
        return form.base.default();
      }
    }
  },
  editCategory: {
...
const canEditContentType = (data, modifiedData) => {
  ...
  const contentTypeAttributes = get__default.default(data, ["contentType", "schema", "attributes"], []);
...
const getFormInputNames = (form2) => form2.reduce((acc, current) => {
...
const sortContentType = (types2) => sortBy__default.default(
  Object.keys(types2).map((uid) => ({
    visible: types2[uid].schema.visible,
    name: uid,
    title: types2[uid].schema.displayName,
    plugin: types2[uid].plugin || null,
    uid,
    to: `/plugins/${index$1.pluginId}/content-types/${uid}`,
    kind: types2[uid].schema.kind,
    restrictRelationsTo: types2[uid].schema.restrictRelationsTo
  })).filter((obj) => obj !== null),
...
const DataManagerProvider = ({ children }) => {
  ...
  const { getPlugin } = helperPlugin.useStrapiApp();
  const { apis } = getPlugin(index$1.pluginId);
  ...
  const contentTypeMatch = reactRouterDom.useRouteMatch(`/plugins/${index$1.pluginId}/content-types/:uid`);
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./index-0f118a94.js")));
const RecursivePath = () => {
  const { url } = reactRouterDom.useRouteMatch();
  const { categoryUid } = reactRouterDom.useParams();
  return /* @__PURE__ */ jsxRuntime.jsx(React.Suspense, { fallback: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.LoadingIndicatorPage, {}), children: /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Switch, { children: /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { path: `${url}/:componentUid`, children: /* @__PURE__ */ jsxRuntime.jsx(ListView$1, { categoryId: categoryUid }) }) }) });
};
const ListView = React.lazy(() => Promise.resolve().then(() => require("./index-0f118a94.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-0f00418d.js.map
