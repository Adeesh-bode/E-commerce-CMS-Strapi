...
const index = require("./index-0f00418d.js");
const styled = require("styled-components");
require("react-helmet");
require("@strapi/design-system/v2");
require("./index-e2b1b2e6.js");
require("immer");
require("lodash/set");
...
ComponentList.propTypes = {
  ...
  customRowComponent: PropTypes__default.default.func,
  firstLoopComponentUid: PropTypes__default.default.string,
  isFromDynamicZone: PropTypes__default.default.bool,
  isNestedInDZComponent: PropTypes__default.default.bool
};
...
`;
function ComponentCard({ component, dzName, index: index$1, isActive, isInDevelopmentMode, onClick }) {
...
ComponentCard.propTypes = {
  component: PropTypes__default.default.string,
  dzName: PropTypes__default.default.string.isRequired,
  index: PropTypes__default.default.number.isRequired,
  isActive: PropTypes__default.default.bool,
  isInDevelopmentMode: PropTypes__default.default.bool,
...
DynamicZoneList.propTypes = {
  addComponent: PropTypes__default.default.func,
  components: PropTypes__default.default.instanceOf(Array),
  customRowComponent: PropTypes__default.default.func,
...
List.propTypes = {
  addComponentToDZ: PropTypes__default.default.func,
  customRowComponent: PropTypes__default.default.func,
  editTarget: PropTypes__default.default.string.isRequired,
  firstLoopComponentUid: PropTypes__default.default.string,
  isFromDynamicZone: PropTypes__default.default.bool,
  isNestedInDZComponent: PropTypes__default.default.bool,
  isMain: PropTypes__default.default.bool,
  items: PropTypes__default.default.instanceOf(Array),
  secondLoopComponentUid: PropTypes__default.default.string,
  targetUid: PropTypes__default.default.string,
  isSub: PropTypes__default.default.bool
};
...
const UpperFirst = ({ content }) => upperFirst__default.default(content);
...
ListRow.propTypes = {
  configurable: PropTypes__default.default.bool,
  customField: PropTypes__default.default.string,
  editTarget: PropTypes__default.default.string.isRequired,
  firstLoopComponentUid: PropTypes__default.default.string,
  isFromDynamicZone: PropTypes__default.default.bool,
...
const ListRow$1 = React.memo(ListRow);
...
LinkToCMSettingsView.propTypes = {
  ...
  isInContentTypeView: PropTypes__default.default.bool,
  isTemporary: PropTypes__default.default.bool,
  targetUid: PropTypes__default.default.string
};
const LinkToCMSettingsView$1 = React.memo(LinkToCMSettingsView);
const ListView = () => {
  const { initialData, modifiedData, isInDevelopmentMode, isInContentTypeView, submitData } = index.useDataManager();
  const { formatMessage } = reactIntl.useIntl();
  const { trackUsage } = helperPlugin.useTracking();
  const match = reactRouterDom.useRouteMatch("/plugins/content-type-builder/:kind/:currentUID");
  const {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, children: /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          items: attributes,
          customRowComponent: (props) => /* @__PURE__ */ jsxRuntime.jsx(ListRow$1, { ...props, onClick: handleClickEditField }),
...
//# sourceMappingURL=index-0f118a94.js.map
