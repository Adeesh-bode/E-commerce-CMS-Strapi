...
const errors = require("./errors-141dad4b.js");
const files = require("./files-5c136331.js");
          ...
          switch (name) {
            ...
            case "typescript": {
              ...
              if (isTypescript) {
                ...
                const { tsconfigBuildFile, tsconfigFile } = await Promise.resolve().then(() => require("./typescript-777ac66e.js"));
            ...
            case "eslint": {
              if (answer) {
                ...
                if (isTypescript) {
                  ...
                  const { tsconfigEslintFile } = await Promise.resolve().then(() => require("./typescript-777ac66e.js"));
                ...
                const { eslintIgnoreFile } = await Promise.resolve().then(() => require("./eslint-9a73913f.js"));
                files2.push(
                  {
                    name: ".eslintrc",
                    contents: outdent.outdent`
...
exports.init = init;
//# sourceMappingURL=init-c4019158.js.map
