          ...
          switch (name) {
            ...
            case "typescript": {
              ...
              if (isTypescript) {
                ...
                const { tsconfigBuildFile, tsconfigFile } = await Promise.resolve().then(() => require("./_chunks/typescript-777ac66e.js"));
            ...
            case "eslint": {
              if (answer) {
                ...
                if (isTypescript) {
                  ...
                  const { tsconfigEslintFile } = await Promise.resolve().then(() => require("./_chunks/typescript-777ac66e.js"));
                ...
                const { eslintIgnoreFile } = await Promise.resolve().then(() => require("./_chunks/eslint-9a73913f.js"));
                files.push(
                  {
                    name: ".eslintrc",
                    contents: outdent.outdent`
